...
class sr_dribbble_widget extends WP_Widget {
	...
	function sr_dribbble_widget() {
		...
		// Widget settings
		$widget_ops = array( 'classname' => 'sr_dribbble_widget', 'description' => __('A simple Dribbble Widget to show your Dribbbles.', 'sr_yalu_theme') );
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base', 'sr-dribbble-widget' );

		// Create widget
		$this->WP_Widget( 'sr_dribbble_widget', __('SR - Dribbbles','sr_yalu_theme'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'dribbblename' ); ?>"><?php _e('Dribbble Name', 'sr_yalu_theme') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'dribbbleitems' ); ?>"><?php _e('Dribbble Items', 'sr_yalu_theme') ?></label>
            ...
            <small><?php _e('Choose a number of items (max = 30)', 'sr_yalu_theme'); ?></small>
		</p>
