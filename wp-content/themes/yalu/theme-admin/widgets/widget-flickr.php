...
class sr_flickr_widget extends WP_Widget {
	...
	function sr_flickr_widget() {
		...
		// Widget settings
		$widget_ops = array( 'classname' => 'sr_flickr_widget', 'description' => __('A simple flickr Widget to show your flickr images.', 'sr_yalu_theme') );
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base', 'sr-flickr-widget' );

		// Create widget
		$this->WP_Widget( 'sr_flickr_widget', __('SR - Flickr','sr_yalu_theme'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'flickrid' ); ?>"><?php _e('Flickr ID', 'sr_yalu_theme') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'flickritems' ); ?>"><?php _e('Flickr Items', 'sr_yalu_theme') ?></label>
