...
class sr_tag_widget extends WP_Widget {
	...
	function sr_tag_widget() {
		...
		// Widget settings
		$widget_ops = array( 'classname' => 'sr_tag_widget', 'description' => __('A simple tag Widget.', 'sr_yalu_theme') );
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base', 'sr-tag-widget' );

		// Create widget
		$this->WP_Widget( 'sr_tag_widget', __('SR - Tags','sr_yalu_theme'), $widget_ops, $control_ops );
	}
